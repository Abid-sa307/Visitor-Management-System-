        ...
        <div class="content">
            ...
            <div style="background: #e0f2fe; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #0ea5e9;">
                ...
                <div style="text-align: center;">
                    <a href="{{ route('public.visitor.show', ['company' => $visitor->company_id, 'visitor' => $visitor->id]) }}" 
                ...
                <p style="margin: 15px 0 0 0; font-size: 12px; color: #64748b;">
                    ...
                    <span style="word-break: break-all;">{{ route('public.visitor.show', ['company' => $visitor->company_id, 'visitor' => $visitor->id]) }}</span>
                </p>
            </div>
