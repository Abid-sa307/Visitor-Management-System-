...
<head>
    <meta charset="UTF-8">
    <title>Pricing | Smart Visitor Management System</title>
...
<section class="pricing-header">
    <div class="container">
        ...
        <p>Choose the plan that works best for your organization. All plans include access to our core visitor management features.</p>
        ...
        <div class="accordion" id="faqAccordion">
            ...
            <div class="accordion-item">
                ...
                <div id="faqCollapse4" class="accordion-collapse collapse" aria-labelledby="faqHeading4"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        Yes, we offer special pricing for non-profit organizations. Contact our sales team for details.
                    </div>
                </div>
            </div>
