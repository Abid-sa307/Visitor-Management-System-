                                            ...
                                            <div class="card-body">
                                                ...
                                                @if($question->type === 'yes_no')
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="yes_{{ $index }}">
                                                            Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="responses[{{ $index }}]" 
                                                               id="no_{{ $index }}" value="no" required>
                                                        <label class="form-check-label" for="no_{{ $index }}">
                                                            No
                                                        </label>
                                                    </div>
                                                ...
                                                @elseif($question->type === 'multiple_choice')
                                                    @if($question->options)
                                                        ...
                                                        @foreach($options as $option)
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="responses[{{ $index }}]" 
                                                                       id="option_{{ $index }}_{{ $loop->index }}" value="{{ $option }}" required>
                                                                <label class="form-check-label" for="option_{{ $index }}_{{ $loop->index }}">
                                                                    {{ $option }}
                                                                </label>
                                                            </div>
                                                        @endforeach
                ...
                <!-- Security Officer Information -->
                            ...
                            <div class="mb-4">
                                ...
                                <div class="border rounded p-3 text-center" id="photoCaptureArea">
                                    ...
                                    <input type="hidden" name="visitor_photo" id="visitorPhotoInput">
                                </div>
                            </div>
