@props(['name', 'id' => null, 'value' => '', 'placeholder' => '', 'required' => false, 'disabled' => false])
...
<div x-data="{ show: false }" class="relative">
    <div class="relative">
        <input 
            ...
            {{ $disabled ? 'disabled' : '' }}
            {{ $attributes->merge([
                'class' => 'w-full pr-10 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out'
            ]) }}
        >
        <button 
            type="button" 
