...
@section('title', $seo['title'] ?? 'Top Visitor Management Software | Top Visitor Management System ')
...
@verbatim
    <style>
        ...
        .navbar-brand { font-weight: 700; font-size: 1.8rem; background: linear-gradient(to right, var(--primary), var(--secondary)); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
        .logo-img { height: 55px; width: auto; margin-right: 10px; display: block; }
        .navbar .nav-link { font-weight: 500; position: relative; margin: 0 .6rem; color: var(--dark) !important; transition: color .25s ease; }
        .navbar .nav-link:hover, .navbar .nav-link.active { color: var(--primary) !important; }
        
        /* Hero Section - Consolidated and Fixed */
        .hero {
            ...
            <div class="row align-items-center min-vh-75">
                ...
                <div class="col-lg-6 text-white">
                    <h1 class="display-4 fw-bold animate-fadeIn mb-4">
                        {{ $hero['title'] ?? 'N&T Software Visitor Management Software in ' . ($locationDisplay ?: 'your city') . ' for All Workplaces' }}
                    </h1>
