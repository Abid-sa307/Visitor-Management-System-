...
<head>
    ...
    <title>VMS for Residential Societies | Secure Community Visitor Management</title>
...
<body class="residential-page">
    ...
    <section class="residential-hero">
        <div class="container">
            <h1>Secure Residential Society Visitor Management</h1>
    ...
    <section id="faq" class="py-5 bg-light">
        <div class="container">
            <div class="section-title">
                ...
                <p>Find answers to common questions about our residential visitor management system</p>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="faq-item">
                        <div class="faq-question">
                            <span>How does the pre-approval feature work for residents?</span>
                            <i class="bi bi-chevron-down"></i>
                        </div>
                        <div class="faq-answer">
                            <p>Residents can use our mobile app or web portal to pre-approve visitors by entering their
                                details and visit date/time. The security team receives this information, and visitors
                                can check in quickly upon arrival without additional verification.</p>
                        </div>
                    </div>
                    <div class="faq-item">
                        <div class="faq-question">
                            <span>Can the system integrate with our existing security cameras?</span>
                            <i class="bi bi-chevron-down"></i>
                        </div>
                        <div class="faq-answer">
                            <p>Yes, ResidentVMS can integrate with most modern CCTV systems. This allows for capturing
                                visitor photos automatically and linking them to visitor records for enhanced security.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item">
                        <div class="faq-question">
                            <span>How long does implementation typically take for a residential society?</span>
                            <i class="bi bi-chevron-down"></i>
                        </div>
                        <div class="faq-answer">
                            <p>Most societies are operational within 2-4 weeks. The timeline depends on the size of your
                                community, hardware requirements, and resident onboarding process. Our implementation
                                team guides you through every step.</p>
                        </div>
                    </div>
                    <div class="faq-item">
                        <div class="faq-question">
                            <span>What training is provided for our security staff and residents?</span>
                            <i class="bi bi-chevron-down"></i>
                        </div>
                        <div class="faq-answer">
                            <p>We provide comprehensive training for security personnel and administrative staff. For
                                residents, we offer easy-to-follow guides, video tutorials, and in-app guidance. Our
                                support team is available to assist with any questions.</p>
                        </div>
                    </div>
                </div>
            </div>
