...
use App\Models\Company;  // Import Company model for superadmin filter
    ...
    public function index(Request $request)
{
    ...
    // Determine the company filter based on user role
    $selectedCompany = $request->company_id ?? ($user->role === 'company' ? $user->company_id : null);
    ...
    return view('dashboard', compact(
        ...
        'deptCounts',
        'visitorsByDate',
        'companies',  // Pass companies for superadmin filter
        'selectedCompany'  // Pass the selected company for filtering
    ));
}
}
